...
const CHARS = [
  ...
  { id: "package-gnome", name: "Crafter", title: "Master Packager", machine: "package", signature: "White hair, purple hooded top, leather craft apron", prompt: "A stocky female gnome character, 3.5 heads tall, wearing a purple pointed hat with brown accent band and RIGGG hexagonal shield-checkmark badge, a purple hooded top, brown leather craft apron with visible tool loops and small pouches, brown leather belt with brass buckle and copper hand tools attached, brown leather boots. Long white hair falling from beneath the hat, warm brown eyes, pink-blushed round cheeks, rounded pink nose, pointed ears. Expression: warm and industrious, the satisfied focus of a maker mid-task. Match the reference image for hair, face, gender, and held objects.", refs: ["crafter_package-purple.png"] },
  { id: "publish-gnome", name: "Router", title: "Distribution Chief", machine: "publish", signature: "Short white beard, blue overalls over yellow shirt, delivery satchel", prompt: "A stocky gnome character, 3.5 heads tall, wearing a blue pointed hat with slight lean and RIGGG hexagonal shield-checkmark badge, a bright yellow shirt beneath blue overalls with brass button closures, brown leather belt with satchel and tool pouches, brown work boots. Short trimmed white beard and mustache, warm brown eyes, round red-tipped nose, pink-blushed cheeks, pointed ears. Alert forward-leaning posture like someone mid-delivery. Expression: energetic and dependable, ready to move. Match the reference image for hair, face, gender, and held objects.", refs: ["router_publish-blue.png", "distribution-engine_publish-blue.png"] },
  { id: "prove-gnome", name: "Lens", title: "Chief Analyst", machine: "prove", signature: "White braid, teal coveralls, magnifying glass & red clipboard", prompt: "A stocky female gnome character, 3.5 heads tall, wearing a teal pointed hat with slight lean and red RIGGG hexagonal shield-checkmark badge, head-to-toe teal coveralls with small shield accents, brown leather belt with brass buckle and tool pouches, brown leather boots. Long white braid falling from beneath the hat, warm brown eyes, pink-blushed round cheeks, rounded pink nose, pointed ears. Holds a bronze-rimmed magnifying glass in one hand and a red clipboard in the other. Expression: cheerful and observant, curious rather than stern. Match the reference image for hair, face, gender, and held objects.", refs: ["lens_prove-red.png"] },
  { id: "preserve-gnome", name: "Keeper", title: "Chief Archivist", machine: "preserve", signature: "Full white beard, amber outfit, glass preservation jar", prompt: "A stocky gnome character, 3.5 heads tall, wearing an amber pointed hat with RIGGG hexagonal shield-checkmark badge, an amber shirt, brown leather archival apron with pockets and a small ledger tucked in, brown leather belt with brass fittings, brown leather boots. Full rounded white beard, warm brown eyes, pink-blushed round cheeks, rounded pink nose, pointed ears. Holds a large glass preservation jar with amber contents visible. Expression: warm and protective, the careful attention of someone who keeps things safe for the long term. Match the reference image for hair, face, gender, and held objects.", refs: ["keeper_preserve-amber.png"] },
];
...
export default function RigggPromptBuilder() {
  ...
  function doGenerate() {
    ...
    var ASSET_REGISTRY = {
      ...
      "crafter_package-purple.png": { path: "characters/package-gnome/canonical/crafter_package-purple.png", type: "character", owner: "package-gnome", role: "Crafter character identity — preserve this female gnome's white hair, purple hooded top with shield badge, brown leather craft apron, and warm industrious expression" },
      "router_publish-blue.png": { path: "characters/publish-gnome/canonical/router_publish-blue.png", type: "character", owner: "publish-gnome", role: "Router character identity — preserve this gnome's short trimmed white beard, blue overalls over bright yellow shirt, delivery satchel, and forward-leaning energy" },
      "lens_prove-red.png": { path: "characters/prove-gnome/canonical/lens_prove-red.png", type: "character", owner: "prove-gnome", role: "Lens character identity — preserve this female gnome's long white braid, teal head-to-toe coveralls, bronze magnifying glass, and red clipboard" },
      "keeper_preserve-amber.png": { path: "characters/preserve-gnome/canonical/keeper_preserve-amber.png", type: "character", owner: "preserve-gnome", role: "Keeper character identity — preserve this gnome's full rounded white beard, amber hat and shirt, glass preservation jar, and brown leather archival apron" },
    };
