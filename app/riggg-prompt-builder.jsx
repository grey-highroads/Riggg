...
const CHARS = [
  ...
  { id: "publish-gnome", name: "Router", title: "Distribution Chief", machine: "publish", signature: "Manifest clipboard, routing stamps, windswept beard", prompt: "A stocky gnome character, 3.5 heads tall, wearing a blue pointed hat with RIGGG hexagonal logo, blue work shirt, teal overalls with multiple belt pockets containing routing stamps and channel labels, brown leather belt with brass buckle and manifest clipboard holster, teal work gloves, heavy teal-brown boots with brass hardware. White beard slightly windswept, large round teal-blue eyes with alert efficient expression, round pink-blushed nose, pointed ears. Expression: energetic competence, mid-action.", refs: ["spark_produce-green.png", "distribution-engine_publish-blue.png"] },
